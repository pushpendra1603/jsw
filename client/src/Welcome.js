    ...
    render(){
        ...
        return (<div>
            ...
            <div className={"card col-md-8 col-xl-11 bg-dark"} style={{color: 'white'}} align="left">
                <h3>Contact Us:</h3>
                <h5>
                    <label>Name:</label> <label>Pushpendra Upadhyay</label><br/>
                    <label>Contact:</label> <label>810797072</label><br/>
                    <label>Email:</label> <label>pushpendra1603@gmail.com</label><br/>
